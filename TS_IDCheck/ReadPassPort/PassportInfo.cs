...
namespace TS_IDCheck
{
    ...
    public class PassportInfo
    {
        ...
        public void copyData(PassportInfo info)
        {
            ...
            EnglishFamilyName = info.EnglishFamilyName;
            EnglishGivienName = info.EnglishGivienName;
            MRZ1 = info.MRZ1;
            MRZ2 = info.MRZ2;
            ...
            RFIDMRZ = info.RFIDMRZ;
            OCRMRZ = info.OCRMRZ;
            PlaceOfBirthPinyin = info.PlaceOfBirthPinyin;
            PlaceOfIssuePinyin = info.PlaceOfIssuePinyin;
            PersonalIdNo = info.PersonalIdNo;
            NamePinyinOCR = info.NamePinyinOCR;
            SexOCR = info.SexOCR;
            NationalityOCR = info.NationalityOCR;
            PersonalIdNoOCR = info.PersonalIdNoOCR;
            PlaceOfBirthOCR = info.PlaceOfBirthOCR;
            DateOfExpiryOCR = info.DateOfExpiryOCR;
            AuthorityOCR = info.AuthorityOCR;
            FamilyName = info.FamilyName;
            GivienName = info.GivienName;
            Photo = info.Photo;
            PhotoHead = info.PhotoHead;
            Nation = info.Nation;
        }
